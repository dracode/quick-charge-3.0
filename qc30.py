...
# This might be over-engineered, but I wanted to implement as many features as possible for the sake of demonstration.  If this is too verbose to fit within your memory constraints, a more minimal version could be written by reducing this to just the handshake, switch to continuous mode, and increment/decrement pulses. 
